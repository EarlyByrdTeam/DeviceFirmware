...
void IA::PerformFrequencySweep()
{
	...
	if (IA_DATA.range)
	{ //Range needs to be set before performing a freq sweep
...
double IA::getGF()
{
	...
	{
	case 20:
		Serial.println(IA_DATA.gf_value_20, 10);
		gain_value = IA_DATA.gf_value_20;
		break;
	case 100:
		Serial.println(IA_DATA.gf_value_100K, 10);
		gain_value = IA_DATA.gf_value_20;
		break;
	default:
		break;
